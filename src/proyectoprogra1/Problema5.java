...
public class Problema5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelTITULO.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Etapa 1 - Problema 5", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
        ...
        jLabel2.setText("Planteo: El programa le permitirá calcular el impuesto sobre la renta en Costa Rica. Recuerde que se aplica un 10% de impuesto en");

        jLabel8.setText("salarios entre 817 000 y 1 226 000, y 15% para mayores de 1 226 000. El impuesto aplica solo al excedente.");
        ...
        jPanelC.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "C) Para todo salario S que exceda 1 226 000, el impuesto en el tracto de 10% seria siempre de:", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        jRadioButtonC1.setText("(S - 817 000) * 0.1");
        ...
        jRadioButtonC3.setText("((S - 1 226 000) * 0.15) + 40 900");
        ...
        jPanelD.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "D) ¿Como se calcula el impuesto cuando \" (S < 1 226 000) && (S > 817 000) \"?", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        jRadioButtonD1.setText("(S - 817 000) * 0.1");
        ...
        jRadioButtonD3.setText("((S - 1 226 000) * 0.15) + 40 900");
        ...
        jPanelE.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "E) Para cualquier salario S menor que 817 000, ¿cual sería el Output obtenido por el usuario?", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        jRadioButtonE1.setText("\"Su salario no debe pagar impuesto sobre la renta\"");
        ...
        jRadioButtonE2.setText("\"Su impuesto es de \"+(S*0.1)");
        ...
        jRadioButtonE3.setText("\"Su impuesto es de \"+(S*0.15)");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Problema5.png"))); // NOI18N
